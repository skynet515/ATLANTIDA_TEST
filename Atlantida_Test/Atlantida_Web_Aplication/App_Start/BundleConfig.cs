    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/Api").Include(
                      "~/JScripts/Sesion.js",
                       "~/JScripts/cus_functions.js"
                        

                     ));
            bundles.Add(new StyleBundle("~/Content/Tarjeta").Include(
                       "~/JScripts/Statement.js"

                   ));
            bundles.Add(new StyleBundle("~/Content/TransaccionesMensuales").Include(
                       "~/JScripts/history.js"

                   ));
            bundles.Add(new StyleBundle("~/Content/Compras").Include(
                       "~/JScripts/purcharse.js",
                       "~/JScripts/cus_functions.js"

                   ));

            bundles.Add(new StyleBundle("~/Content/Pagos").Include(
                       "~/JScripts/payments.js",
                        "~/JScripts/cus_functions.js"
